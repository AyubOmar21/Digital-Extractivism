...
function changeEra(eraName) {
    ...
    setTimeout(() => {
        ...
        if (eraName === 'scramble') {
            ...
            description.innerText = "Witness the rapid colonization of the continent...";
        } 
        else if (eraName === 'present') {
            title.innerText = "Capital, Corp, Control";
            description.innerText = "A view of the modern political landscape...";
        } 
            ...
            description.innerText = "The hidden cost of resources and energy...";
        }
...
const scenes = {
    ...
    'present-southern-frontier': [85, 125, 0.35],
...
const observer = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
        ...
        if (entry.isIntersecting) {
            ...
            // If we are already fading/swapping, we ignore new Era requests
            if (!isTransitioning) {
            ...
            // Even if we are transitioning Eras, the camera needs to keep moving
    ...
    // CHANGE: Lower threshold (0.3) means the app reacts sooner.
    // This removes the "dead zone" where nothing is active.
    threshold: 0.3 
});
